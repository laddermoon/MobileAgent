...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="Run Mobile-Agent-v3 with Aliyun GUI-Plus API"
    )
    parser.add_argument("--adb_path", type=str, default="/opt/homebrew/bin/adb")
    parser.add_argument("--hdc_path", type=str, default=None)   
    parser.add_argument("--api_key", type=str, default=None, help="Aliyun API Key (optional, read from APIKEY env var)")
    parser.add_argument("--base_url", type=str, default="https://dashscope.aliyuncs.com/compatible-mode/v1")
    parser.add_argument("--model", type=str, default="gui-plus")
